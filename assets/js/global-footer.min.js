(function(){"use strict";function e(){if(document.getElementById("site-footer"))return;if(!document.getElementById("footer-container")){console.warn("SJMaths: #footer-container not found. Appending one.");const a=document.createElement("div");a.id="footer-container",document.body.appendChild(a)}const s=`
        <style>
        ...
        </footer>`,t=document.getElementById("footer-container");t.innerHTML=s}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();
