(function(){"use strict";function t(){if(document.getElementById("site-footer"))return;if(!document.getElementById("footer-container")){console.warn("SJMaths: #footer-container not found. Appending one.");const i=document.createElement("div");i.id="footer-container",document.body.appendChild(i)}const a=`
        <style>
        ...
        `,document.body.appendChild(e)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):t()})();
