(function(){"use strict";function i(){if(document.getElementById("site-footer"))return;if(!document.getElementById("footer-container")){console.warn("SJMaths: #footer-container not found. Appending one.");const s=document.createElement("div");s.id="footer-container",document.body.appendChild(s)}const a=`
        <style>
        ...
        <footer id="site-footer" class="sf notranslate">
          <div class="sf-inner">
        ...
        </footer>`,t=document.getElementById("footer-container");t&&(t.innerHTML=a),l()}function l(){if(document.querySelector(".mobile-bottom-nav"))return;const e=document.createElement("div");e.className="mobile-bottom-nav",e.setAttribute("role","navigation"),e.setAttribute("aria-label","Mobile Bottom Navigation");const a=window.location.pathname,t=a==="/"||a==="/index.html"||a.endsWith("/index.html")||a==="",s=a.includes("/search.html"),o=a.includes("/profile.html"),n=a.includes("/competitive-exams")||a.includes("/ssc-cgl")||a.includes("/upsc")||a.includes("/ahc-ro-aro"),r=(a.includes("/pages/index.html")||a.includes("/class-9-maths")||a.includes("/class-10-maths")||a.includes("/class-11-maths")||a.includes("/class-12-maths")||a.includes("/pages/")&&!s&&!o&&!a.includes("/about.html")&&!a.includes("/contact.html")&&!a.includes("/terms.html")&&!a.includes("/privacy-policy.html")&&!a.includes("/cookie-policy.html"))&&!n;e.innerHTML=`
            <a href="/" class="nav-item ${t?"active":""}">
                <i class="fas fa-home"></i>
                <span>Home</span>
            </a>
            <a href="/competitive-exams/" class="nav-item ${n?"active":""}">
            ...
            <a href="/profile.html" class="nav-item ${o?"active":""}">
