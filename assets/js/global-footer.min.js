(function(){"use strict";function e(){if(document.getElementById("site-footer"))return;if(!document.getElementById("footer-container")){console.warn("SJMaths: #footer-container not found. Appending one.");const t=document.createElement("div");t.id="footer-container",document.body.appendChild(t)}const o=`
        ...
        </footer>`,a=document.getElementById("footer-container");a.innerHTML=o}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e):e()})();
