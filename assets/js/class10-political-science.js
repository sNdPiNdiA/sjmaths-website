/**
 * class10-political-science.js
 * Unified Client-Side Engine for Class 10 Political Science Chapter Pages
 */
...
(() => {
    ...
    function initDynamicTabNav() {
        tabOrder.forEach((id, i) => {
            ...
            const existingNav = panel.querySelector(".tab-nav");
    ...
    function initGlobalListeners() {
        const back = document.querySelector(".back") || document.getElementById("backTop");
