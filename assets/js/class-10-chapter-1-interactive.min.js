...
function toggleProofStep(header) {
...
function calcFactorsInteractive() {
...
function calcHcfLcmInteractive() {
...
function checkDecimalInteractive() {
...
function checkGamified(btn, isCorrect) {
