(function(){"use strict";function t(){if(document.getElementById("exercise-page-footer"))return;const e=document.createElement("footer");e.id="exercise-page-footer",e.className="exercise-page-footer",e.innerHTML=`
        ...
        `,document.body.appendChild(e);const o=document.querySelector(".nav-buttons-container, .bottom-nav"),a=document.getElementById("footerNav");if(o&&a&&(a.innerHTML=o.innerHTML,o.remove()),!document.getElementById("exercise-footer-styles")){const r=document.createElement("style");r.id="exercise-footer-styles",r.textContent=`
            ...
            `,document.head.appendChild(r)}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",t):t()})();
