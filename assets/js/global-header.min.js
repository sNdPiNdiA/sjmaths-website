(function(){"use strict";function i(){if(document.getElementById("site-header")||document.getElementById("exercise-page-header"))return;if(!document.getElementById("header-container")){console.warn("SJMaths: #header-container not found. Creating one.");const a=document.createElement("div");a.id="header-container",document.body.insertBefore(a,document.body.firstChild)}const e=`
...
</header>`,n=document.getElementById("header-container");n.innerHTML=e;const s=n.querySelector("#headerLangText");if(s){const a=window.location.pathname.includes("/hi/")||document.documentElement.lang==="hi";s.textContent=a?"English":"\u0939\u093F\u0928\u094D\u0926\u0940"}const o=window.location.pathname;n.querySelectorAll(".desktop-nav a").forEach(a=>{const l=a.getAttribute("href");r(o,l)&&a.classList.add("active")})}function r(t,e){if(e==="/"&&t==="/"||e==="/"&&(t==="/index.html"||t==="")||e!=="/"&&t.startsWith(e))return!0;if(e.endsWith("index.html")){const n=e.replace("index.html","");if(t.startsWith(n))return!0}return!1}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",i):i()})();
