...
</header>`,i=document.getElementById("header-container");i.innerHTML=n;const r=i.querySelector("#headerLangText");if(r){const t=window.location.pathname.includes("/hi/")||document.documentElement.lang==="hi";r.textContent=t?"English":"\u0939\u093F\u0928\u094D\u0926\u0940"}const l=window.location.pathname;i.querySelectorAll(".desktop-nav a").forEach(t=>{const c=t.getAttribute("href");o(l,c)&&t.classList.add("active")})}function o(e,a){if(a==="/"&&e==="/"||a==="/"&&(e==="/index.html"||e==="")||a!=="/"&&e.startsWith(a))return!0;if(a.endsWith("index.html")){const n=a.replace("index.html","");if(e.startsWith(n))return!0}return!1}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",s):s()})();
