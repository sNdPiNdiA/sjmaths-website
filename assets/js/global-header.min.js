...
</header>`,i=document.getElementById("header-container");i.innerHTML=e;const r=window.location.pathname;i.querySelectorAll(".desktop-nav a").forEach(t=>{const o=t.getAttribute("href");n(r,o)&&t.classList.add("active")})}function n(a,e){if(e==="/"&&a==="/"||e==="/"&&(a==="/index.html"||a==="")||e!=="/"&&a.startsWith(e))return!0;if(e.endsWith("index.html")){const i=e.replace("index.html","");if(a.startsWith(i))return!0}return!1}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",s):s()})();
