...
const PYQ_DIR = path.join(ROOT_DIR, 'class-10-maths', 'previous-year-questions', 'chapter-wise');
...
console.log(`Found ${htmlFiles.length} PYQ HTML files to process.`);
...
console.log(`🎉 Successfully pre-rendered static HTML question cards into ${prerenderedCount} PYQ pages.`);
