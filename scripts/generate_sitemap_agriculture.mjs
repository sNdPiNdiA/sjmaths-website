...
const OUTPUT_SITEMAP = 'sitemap-agriculture.xml';
...
const hubUrls = [
  { loc: 'https://sjmaths.com/agriculture/', priority: '1.0', changefreq: 'weekly' },
  { loc: 'https://sjmaths.com/up-tgt-agriculture/', priority: '0.9', changefreq: 'weekly' },
  { loc: 'https://sjmaths.com/up-pgt-agriculture/', priority: '0.9', changefreq: 'weekly' },
];
