...
console.log('=== Chemistry Content Audit & Verification ===\n');
...
const emptyDirs = findEmptyDirs(path.resolve('chemistry'));
...
console.log(`Empty Directories in chemistry/: ${emptyDirs.length}`);
