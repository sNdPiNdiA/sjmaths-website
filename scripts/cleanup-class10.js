...
const startDir = path.join(__dirname, '../classes/class-10/ncert-exercise-practice');
...
function processFile(filePath) {
    ...
    // 1. Remove Embedded CSS (Page-specific overrides)
    // Matches <style>/* Page-specific overrides only */ ... </style>
    const styleRegex = /<style>\/\* Page-specific overrides only \*\/[\s\S]*?<\/style>/i;
...
// Main Execution
console.log('Starting Class 10 Cleanup...');
