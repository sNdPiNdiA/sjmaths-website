...
en_data['labels']['mockIntro']['description'] = "Contains 10 multi-statement questions testing conceptual understanding of Portuguese administration, battles, and trade networks. 1/3 negative marking applies."
...
hi_data['labels']['mockIntro']['description'] = "पुर्तगाली प्रशासन, लड़ाइयों और व्यापारिक नेटवर्क की वैचारिक समझ का परीक्षण करने वाले 10 बहु-कथनीय प्रश्न शामिल हैं। 1/3 नकारात्मक अंकन प्रणाली लागू है।"
