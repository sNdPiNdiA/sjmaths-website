const CACHE_NAME = 'sjmaths-vc7a1e2f00';
const ASSETS = [
    './',
    './index.html',
    './offline.html',
    './assets/css/main.min.css?v=8e61f957',
    './assets/css/layout.min.css?v=6474513b',
    './assets/css/component.min.css?v=1b0d8088',
    './assets/css/improved-ui.min.css?v=2b849b2e',
