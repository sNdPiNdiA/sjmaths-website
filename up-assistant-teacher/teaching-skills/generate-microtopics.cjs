...
// ============================================================================
// TEACHING SKILLS MICROTOPICS
// ============================================================================
const MICROTOPICS = [
    {
        dir: 'teaching-methods-skills',
        name: 'Teaching Methods & Skills',
        hindiName: 'शिक्षण की विधियाँ एवं कौशल',
        description: 'Teaching methods and skills - active learning methods, teaching styles, microteaching, classroom communication.',
        keywords: ['Teaching Methods', 'Teaching Skills', 'Microteaching', 'Classroom Communication', 'Pedagogy']
    },
    {
        dir: 'principles-of-teaching-learning',
        name: 'Principles of Teaching & Learning',
        hindiName: 'शिक्षण अधिगम के सिद्धान्त',
        description: 'Principles of teaching and learning - motivation, interest, individual differences, activity-based learning.',
        keywords: ['Principles of Teaching', 'Teaching Principles', 'Learning Principles', 'Pedagogical Theories', 'Active Learning']
    },
    {
        dir: 'current-indian-society-elementary-education',
        name: 'Current Indian Society & Elementary Education',
        hindiName: 'वर्तमान भारतीय समाज एवं प्रारम्भिक शिक्षा',
        description: 'Current Indian society and elementary education - historical context, constitutional provisions, educational reforms.',
        keywords: ['Indian Society', 'Elementary Education', 'Constitutional Education', 'Educational History', 'Reforms']
    },
    {
        dir: 'inclusive-education',
        name: 'Inclusive Education',
        hindiName: 'समावेशी शिक्षा',
        description: 'Inclusive education - teaching diverse learners, children with special needs (CWSN), learning disabilities, integration.',
        keywords: ['Inclusive Education', 'CWSN', 'Special Needs', 'Learning Disabilities', 'Differentiation']
    },
    {
        ...
        description: 'New initiatives in elementary education - government schemes, Sarva Shiksha Abhiyan, RTE Act 2009, education policies.',
        keywords: ['New Initiatives', 'Elementary Schemes', 'SSA', 'RTE Act 2009', 'NEP', 'Education Schemes']
    },
    {
        dir: 'educational-evaluation-measurement',
        name: 'Educational Evaluation & Measurement',
        hindiName: 'शैक्षिक मूल्यांकन एवं मापन',
        description: 'Educational evaluation and measurement - continuous and comprehensive evaluation (CCE), testing, diagnostic and remedial teaching.',
        keywords: ['Educational Evaluation', 'Measurement', 'CCE', 'Remedial Teaching', 'Formative Assessment', 'Summative Assessment']
    },
    {
        dir: 'initial-reading-skills',
        name: 'Initial Reading Skills',
        hindiName: 'आरम्भिक पठन कौशल',
        description: 'Initial reading skills - phonics, vocabulary development, reading comprehension, methods of teaching reading.',
        keywords: ['Initial Reading', 'Reading Skills', 'Phonics', 'Vocabulary', 'Comprehension', 'Literacy Development']
    },
    {
        dir: 'educational-management-administration',
        name: 'Educational Management & Administration',
        hindiName: 'शैक्षिक प्रबन्धन एवं प्रशासन',
        description: 'Educational management and administration - school management committees (SMC), resource management, leadership, school environment.',
        keywords: ['Educational Management', 'School Administration', 'SMC', 'Resource Management', 'Leadership', 'School Environment']
    }
];
        ...
        sections: [
            {
                ...
                rows: [
                    ...
                    ['Subject', '**Teaching Skills** for UP Assistant Teacher'],
...
async function main() {
    console.log('╔══════════════════════════════════════════════════════════════╗');
    console.log('║ UP Assistant Teacher - Teaching Skills Microtopics Generator║');
    ...
    for (let i = 0; i < totalTopics; i++) {
        ...
        // Create microtopic folder directly under teaching-skills
        const outputDir = path.join(process.cwd(), 'up-assistant-teacher', 'teaching-skills', topic.dir);
    ...
    console.log(`${'='.repeat(80)}`);
    console.log('\n✅ All Teaching Skills microtopic pages generated successfully!');
    console.log('📁 Microtopic folders created directly under: up-assistant-teacher/teaching-skills/');
}
...
function assembleMicrotopicPage(topic, conceptsData) {
    ...
    const canonicalUrl = `https://sjmaths.com/up-assistant-teacher/teaching-skills/${topic.dir}/`;
    const title = `${topic.name} | ${topic.hindiName} - शिक्षण कौशल | SJMaths`;
...
<head>
    ...
    <meta name="keywords" content="${topic.keywords.join(', ')}, UP Assistant Teacher, शिक्षण कौशल, Teaching Skills">
...
<body>
    ...
    <main class="topic-container" id="main-content">
        <a href="/up-assistant-teacher/teaching-skills/" class="back-link"><i class="fas fa-arrow-left"></i> <span class="lang-hi">वापस शिक्षण कौशल पर जाएँ</span><span class="lang-en">Back to Teaching Skills</span></a>

        <div class="breadcrumbs">
            <a href="/">Home</a> <i class="fas fa-chevron-right"></i>
            <a href="/up-assistant-teacher/">UP Assistant Teacher</a> <i class="fas fa-chevron-right"></i>
            <a href="/up-assistant-teacher/teaching-skills/">शिक्षण कौशल</a> <i class="fas fa-chevron-right"></i>
        ...
        ${JSON.stringify({
            topicId: 'up-assistant-teacher.teaching-skills.' + topic.dir,
            topicName: topic.name,
            hindiName: topic.hindiName,
            subject: 'Teaching Skills',
            subjectDir: 'teaching-skills',
