...
// ============================================================================
// LIFE SKILL MANAGEMENT MICROTOPICS
// ============================================================================
const MICROTOPICS = [
    {
        dir: 'professional-conduct-ethics',
        name: 'Professional Conduct & Ethics',
        hindiName: 'व्यावसायिक आचरण एवं नीति',
        description: 'Professional conduct and ethics for teachers - code of conduct, ethical responsibilities, teacher-student relationship, academic integrity.',
        keywords: ['Professional Conduct', 'Teacher Ethics', 'Code of Conduct', 'Academic Integrity', 'Professionalism']
    },
    {
        dir: 'motivation-its-role-in-learning',
        name: 'Motivation & Its Role in Learning',
        hindiName: 'प्रेरणा एवं अधिगम में इसकी भूमिका',
        description: 'Motivation and its role in learning - types of motivation (intrinsic & extrinsic), theories of motivation, strategies to motivate students.',
        keywords: ['Motivation', 'Role in Learning', 'Intrinsic Motivation', 'Extrinsic Motivation', 'Motivation Theories']
    },
    {
        dir: 'role-of-teacher-facilitator-monitor-leader-guide-counselor',
        name: 'Role of Teacher - Facilitator, Monitor, Leader, Guide, Counselor',
        hindiName: 'शिक्षण की भूमिका',
        description: 'Multifaceted role of a teacher - facilitator of learning, monitor of progress, class leader, guide, and counselor.',
        keywords: ['Role of Teacher', 'Facilitator', 'Guide and Counselor', 'Classroom Leader', 'Mentoring']
    },
    {
        dir: 'constitutional-human-values',
        name: 'Constitutional & Human Values',
        hindiName: 'संवैधानिक और मानवीय मूल्य',
        description: 'Constitutional and human values - democracy, equality, justice, fraternity, human rights, value education in school.',
        keywords: ['Constitutional Values', 'Human Values', 'Value Education', 'Democracy and Equality', 'Human Rights']
    },
    {
        dir: 'effective-implementation-of-reward-punishment-system',
        name: 'Effective Implementation of Reward & Punishment System',
        hindiName: 'दण्ड एवं पुरस्कार व्यवस्था का प्रभावी प्रयोग',
        description: 'Effective implementation of reward and punishment system - reinforcement theories, positive discipline, constructive feedback, legal and psychological aspects of punishment.',
        keywords: ['Reward and Punishment', 'Reinforcement', 'Positive Discipline', 'Constructive Feedback', 'Classroom Management']
    }
];
...
function buildConceptsPrompt(topic) {
    return `You are an expert faculty member for UP Assistant Teacher (जीवन कौशल / प्रबन्धन एवं अभिवृत्ति) exam preparation. Create ULTRA-COMPREHENSIVE, EXAM-FOCUSED concept notes for the topic: "${topic.name}" (${topic.hindiName}).

TOPIC CONTEXT:
- Subject: Life Skill / Management & Attitude (जीवन कौशल / प्रबन्धन एवं अभिवृत्ति)
        ...
        sections: [
            {
                ...
                rows: [
                    ...
                    ['Subject', '**Life Skill / Management & Attitude** for UP Assistant Teacher'],
...
async function main() {
    console.log('╔══════════════════════════════════════════════════════════════╗');
    console.log('║ UP Assistant Teacher - Life Skill Microtopics Generator      ║');
    ...
    for (let i = 0; i < totalTopics; i++) {
        ...
        // Create microtopic folder directly under life-skill-management
        const outputDir = path.join(process.cwd(), 'up-assistant-teacher', 'life-skill-management', topic.dir);
    ...
    console.log(`${'='.repeat(80)}`);
    console.log('\n✅ All Life Skill / Management & Attitude microtopic pages generated successfully!');
    console.log('📁 Microtopic folders created directly under: up-assistant-teacher/life-skill-management/');
}
...
function assembleMicrotopicPage(topic, conceptsData) {
    ...
    const canonicalUrl = `https://sjmaths.com/up-assistant-teacher/life-skill-management/${topic.dir}/`;
    const title = `${topic.name} | ${topic.hindiName} - जीवन कौशल / प्रबन्धन एवं अभिवृत्ति | SJMaths`;
...
<head>
    ...
    <meta name="keywords" content="${topic.keywords.join(', ')}, UP Assistant Teacher, जीवन कौशल, प्रबन्धन एवं अभिवृत्ति, Life Skill Management">
...
<body>
    ...
    <main class="topic-container" id="main-content">
        <a href="/up-assistant-teacher/life-skill-management/" class="back-link"><i class="fas fa-arrow-left"></i> <span class="lang-hi">वापस जीवन कौशल पर जाएँ</span><span class="lang-en">Back to Life Skill / Management</span></a>

        <div class="breadcrumbs">
            <a href="/">Home</a> <i class="fas fa-chevron-right"></i>
            <a href="/up-assistant-teacher/">UP Assistant Teacher</a> <i class="fas fa-chevron-right"></i>
            <a href="/up-assistant-teacher/life-skill-management/">जीवन कौशल / प्रबन्धन एवं अभिवृत्ति</a> <i class="fas fa-chevron-right"></i>
        ...
        ${JSON.stringify({
            topicId: 'up-assistant-teacher.life-skill-management.' + topic.dir,
            topicName: topic.name,
            hindiName: topic.hindiName,
            subject: 'Life Skill / Management & Attitude',
            subjectDir: 'life-skill-management',
