...
// ============================================================================
// CHILD PSYCHOLOGY MICROTOPICS
// ============================================================================
const MICROTOPICS = [
    {
        dir: 'individual-differences',
        name: 'Individual Differences',
        hindiName: 'वैयक्तिक भिन्नता',
        description: 'Individual Differences - understanding unique traits, abilities, and behaviors of each child for UP Assistant Teacher exam.',
        keywords: ['Individual Differences', 'Child Psychology', 'Learning Styles', 'Aptitude', 'Personality', 'Intelligence']
    },
    {
        dir: 'factors-affecting-child-development',
        name: 'Factors Affecting Child Development',
        hindiName: 'बाल विकास को प्रभावित करने वाले कारक',
        description: 'Factors affecting child development - physical, mental, social, and environmental influences on child growth.',
        keywords: ['Child Development', 'Growth Factors', 'Environment', 'Heredity', 'Social Factors', 'Physical Development']
    },
    {
        dir: 'identification-of-learning-needs',
        name: 'Identification of Learning Needs',
        hindiName: 'सीखने की आवश्यकता की पहचान',
        description: 'Identification of learning needs - assessment methods, diagnosis, and addressing learning requirements of students.',
        keywords: ['Learning Needs', 'Assessment', 'Diagnosis', 'Remedial Teaching', 'Evaluation', 'Student Needs']
    },
    {
        dir: 'creating-conducive-learning-environment',
        name: 'Creating Conducive Learning Environment',
        hindiName: 'पढ़ने के लिए वातावरण का सृजन करना',
        description: 'Creating conducive learning environment - classroom management, positive atmosphere, and effective teaching spaces.',
        keywords: ['Learning Environment', 'Classroom Management', 'Positive Environment', 'Teaching Space', 'Student Engagement']
    },
    {
        dir: 'learning-theories-and-classroom-application',
        name: 'Learning Theories & Practical Classroom Application',
        hindiName: 'सीखने के सिद्धान्त तथा कक्षा-शिक्षण में व्यावहारिक उपयोगिता',
        description: 'Learning theories and their practical application in classroom - Behaviorism, Constructivism, Cognitivism, and more.',
        keywords: ['Learning Theories', 'Behaviorism', 'Constructivism', 'Cognitivism', 'Classroom Application', 'Teaching Methods']
    },
    {
        dir: 'special-provisions-for-divyang-students',
        name: 'Special Provisions for Divyang Students',
        hindiName: 'दिव्यांग छात्रों हेतु विशेष व्यवस्था',
        description: 'Special provisions for divyang students - inclusive education, adaptive technologies, and supportive policies.',
        keywords: ['Divyang Students', 'Inclusive Education', 'Special Education', 'Adaptive Technology', 'Rights of Disabled']
    }
];
...
function buildConceptsPrompt(topic) {
    return `You are an expert faculty member for UP Assistant Teacher (बाल मनोविज्ञान) exam preparation. Create ULTRA-COMPREHENSIVE, EXAM-FOCUSED concept notes for the topic: "${topic.name}" (${topic.hindiName}).

TOPIC CONTEXT:
- Subject: Child Psychology (बाल मनोविज्ञान)
...
4. Content must be **comprehensive and exam-focused** — cover ALL important facts, theories, concepts, and principles that UP Assistant Teacher asks.
...
- 3-4 detailed tables with 8-12 rows each covering:
  a) Important Theories/Concepts with their proponents and features
  b) Important Terms/Definitions with explanations
  c) Important Facts/Principles with applications
...
- Cover frequently confused concepts, theories, and facts
...
- Include ALL important theories, concepts, psychologists, and principles.
...
function buildFallbackConcepts(topic) {
    return {
        sections: [
            {
                ...
                rows: [
                    ...
                    ['Subject', '**Child Psychology** for UP Assistant Teacher'],
        ...
        keyTakeaways: [
            ...
            'Focus on important theories, concepts, and principles',
...
async function main() {
    console.log('╔══════════════════════════════════════════════════════════════╗');
    console.log('║ UP Assistant Teacher - Child Psychology Microtopics Generator ║');
    ...
    for (let i = 0; i < totalTopics; i++) {
        ...
        // Create microtopic folder directly under child-psychology
        const outputDir = path.join(process.cwd(), 'up-assistant-teacher', 'child-psychology', topic.dir);
    ...
    console.log(`${'='.repeat(80)}`);
    console.log('\n✅ All Child Psychology microtopic pages generated successfully!');
    console.log('📁 Microtopic folders created directly under: up-assistant-teacher/child-psychology/');
}
...
function assembleMicrotopicPage(topic, conceptsData) {
    ...
    const canonicalUrl = `https://sjmaths.com/up-assistant-teacher/child-psychology/${topic.dir}/`;
    const title = `${topic.name} | ${topic.hindiName} - बाल मनोविज्ञान | SJMaths`;
...
<head>
    ...
    <meta name="keywords" content="${topic.keywords.join(', ')}, UP Assistant Teacher, बाल मनोविज्ञान, Child Psychology">
...
<body>
    ...
    <main class="topic-container" id="main-content">
        ...
        <div class="breadcrumbs">
            ...
            <a href="/up-assistant-teacher/child-psychology/">बाल मनोविज्ञान</a> <i class="fas fa-chevron-right"></i>
        ...
        ${JSON.stringify({
        topicId: 'up-assistant-teacher.child-psychology.' + topic.dir,
        topicName: topic.name,
        hindiName: topic.hindiName,
        subject: 'Child Psychology',
        subjectDir: 'child-psychology',
