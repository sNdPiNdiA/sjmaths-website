...
// ============================================================================
// INFORMATION TECHNOLOGY MICROTOPICS
// ============================================================================
const MICROTOPICS = [
    {
        dir: 'teaching-skills-development',
        name: 'Teaching Skills Development',
        hindiName: 'शिक्षण कौशल विकास',
        description: 'Information technology in teaching skills development - interactive techniques, lesson planning tools, technology integration.',
        keywords: ['Teaching Skills', 'Professional Development', 'EdTech Integration', 'Lesson Planning Tools', 'Interactive Learning']
    },
    {
        dir: 'it-in-classroom-teaching-school-management',
        name: 'IT in Classroom Teaching & School Management',
        hindiName: 'कक्षा-शिक्षण तथा विद्यालय प्रबन्धन में सूचना तकनीकी',
        description: 'IT in classroom teaching and school management - databases, student records, ERP systems, digital registers, communication platforms.',
        keywords: ['Classroom IT', 'School Management', 'Educational ERP', 'Digital Register', 'School Databases']
    },
    {
        dir: 'computers-fundamentals-applications',
        name: 'Computers - Fundamentals & Applications',
        hindiName: 'कम्प्यूटर - आधारभूत संरचना व अनुप्रयोग',
        description: 'Computers - fundamentals and applications - CPU, RAM, input/output devices, operating systems, MS Office, file management.',
        keywords: ['Computer Fundamentals', 'Operating Systems', 'MS Office', 'Hardware Software', 'Input Output Devices']
    },
    {
        dir: 'internet-educational-applications-web-tools',
        name: 'Internet - Educational Applications & Web Tools',
        hindiName: 'इन्टरनेट - शैक्षिक उपयोग',
        description: 'Internet - educational applications and web tools - search engines, online libraries, educational websites, e-learning portals.',
        keywords: ['Internet Education', 'Web Tools', 'E-learning Portals', 'Search Engines', 'Online Libraries']
    },
    {
        dir: 'smartphones-digital-teaching-gadgets',
        name: 'Smartphones & Digital Teaching Gadgets',
        hindiName: 'स्मार्टफोन व डिजिटल शिक्षण साधन',
        description: 'Smartphones and digital teaching gadgets - interactive whiteboards, tablets, projectors, mobile learning apps.',
        keywords: ['Smartphones', 'Teaching Gadgets', 'Whiteboards', 'Projectors', 'Mobile Learning']
    },
    {
        dir: 'oer-open-educational-resources',
        name: 'OER - Open Educational Resources',
        hindiName: 'मुक्त शैक्षिक संसाधन',
        description: 'OER - Open Educational Resources - public domain materials, creative commons licenses, repositories, free curriculum resources.',
        keywords: ['OER', 'Creative Commons', 'Curriculum Resources', 'Free Learning Materials', 'Repositories']
    },
    {
        dir: 'educational-apps-portals-software',
        name: 'Educational Apps, Portals & Software',
        hindiName: 'शिक्षण में उपयोगी ऐप्स व पोर्टल्स',
        description: 'Educational apps, portals, and software - DIKSHA portal, SWAYAM, e-Pathshala, Kahoot, Quizlet, interactive learning software.',
        keywords: ['DIKSHA', 'SWAYAM', 'e-Pathshala', 'Educational Apps', 'Interactive Software']
    },
    {
        dir: 'usage-of-digital-learning-materials',
        name: 'Usage of Digital Learning Materials / E-Content',
        hindiName: 'डिजिटल शिक्षण-सामग्री के उपयोग की जानकारी',
        description: 'Usage of digital learning materials and e-content - digital media formats, PDFs, video lectures, animations, copyright guidelines.',
        keywords: ['Digital Learning Materials', 'E-Content', 'Media Formats', 'Video Lectures', 'Copyright Guidelines']
    }
];
...
function buildConceptsPrompt(topic) {
    return `You are an expert faculty member for UP Assistant Teacher (सूचना तकनीकी) exam preparation. Create ULTRA-COMPREHENSIVE, EXAM-FOCUSED concept notes for the topic: "${topic.name}" (${topic.hindiName}).

TOPIC CONTEXT:
- Subject: Information Technology (सूचना तकनीकी)
        ...
        sections: [
            {
                ...
                rows: [
                    ...
                    ['Subject', '**Information Technology** for UP Assistant Teacher'],
...
async function main() {
    console.log('╔══════════════════════════════════════════════════════════════╗');
    console.log('║ UP Assistant Teacher - Info Tech Microtopics Generator       ║');
    ...
    for (let i = 0; i < totalTopics; i++) {
        ...
        // Create microtopic folder directly under information-technology
        const outputDir = path.join(process.cwd(), 'up-assistant-teacher', 'information-technology', topic.dir);
    ...
    console.log(`${'='.repeat(80)}`);
    console.log('\n✅ All Information Technology microtopic pages generated successfully!');
    console.log('📁 Microtopic folders created directly under: up-assistant-teacher/information-technology/');
}
...
function assembleMicrotopicPage(topic, conceptsData) {
    ...
    const canonicalUrl = `https://sjmaths.com/up-assistant-teacher/information-technology/${topic.dir}/`;
    const title = `${topic.name} | ${topic.hindiName} - सूचना तकनीकी | SJMaths`;
...
<head>
    ...
    <meta name="keywords" content="${topic.keywords.join(', ')}, UP Assistant Teacher, सूचना तकनीकी, Information Technology">
...
<body>
    ...
    <main class="topic-container" id="main-content">
        <a href="/up-assistant-teacher/information-technology/" class="back-link"><i class="fas fa-arrow-left"></i> <span class="lang-hi">वापस सूचना तकनीकी पर जाएँ</span><span class="lang-en">Back to Information Technology</span></a>

        <div class="breadcrumbs">
            <a href="/">Home</a> <i class="fas fa-chevron-right"></i>
            <a href="/up-assistant-teacher/">UP Assistant Teacher</a> <i class="fas fa-chevron-right"></i>
            <a href="/up-assistant-teacher/information-technology/">सूचना तकनीकी</a> <i class="fas fa-chevron-right"></i>
        ...
        ${JSON.stringify({
            topicId: 'up-assistant-teacher.information-technology.' + topic.dir,
            topicName: topic.name,
            hindiName: topic.hindiName,
            subject: 'Information Technology',
            subjectDir: 'information-technology',
