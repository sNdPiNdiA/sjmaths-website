...
// ============================================================================
// ENVIRONMENTAL & SOCIAL STUDIES MICROTOPICS
// ============================================================================
const MICROTOPICS = [
    {
        dir: 'structure-of-the-earth',
        name: 'Structure of the Earth',
        hindiName: 'पृथ्वी की संरचना',
        description: 'Structure of the Earth - layers of Earth, core, mantle, crust for UP Assistant Teacher exam.',
        keywords: ['Structure of Earth', 'Earth Layers', 'Core', 'Mantle', 'Crust', 'Geology']
    },
    {
        dir: 'rivers',
        name: 'Rivers',
        hindiName: 'नदियाँ',
        description: 'Rivers - major rivers of India, their tributaries, and importance for civilization.',
        keywords: ['Rivers', 'Major Rivers', 'Ganga', 'Yamuna', 'Tributaries', 'River System']
    },
    {
        dir: 'mountains',
        name: 'Mountains',
        hindiName: 'पर्वत',
        description: 'Mountains - types, major mountain ranges of India and world, significance.',
        keywords: ['Mountains', 'Himalayas', 'Mountain Ranges', 'Types of Mountains']
    },
    {
        dir: 'continents',
        name: 'Continents',
        hindiName: 'महाद्वीप',
        description: 'Continents - seven continents, their features, and geographical significance.',
        keywords: ['Continents', 'Seven Continents', 'Asia', 'Africa', 'Europe', 'Geography']
    },
    {
        dir: 'oceans-marine-life',
        name: 'Oceans & Marine Life',
        hindiName: 'महासागर व जीव',
        description: 'Oceans and marine life - ocean currents, marine ecosystems, and biodiversity.',
        keywords: ['Oceans', 'Marine Life', 'Ocean Currents', 'Marine Ecosystem', 'Biodiversity']
    },
    {
        dir: 'natural-wealth-resources',
        name: 'Natural Wealth & Resources',
        hindiName: 'प्राकृतिक सम्पदा',
        description: 'Natural wealth and resources - minerals, forests, water resources, and conservation.',
        keywords: ['Natural Resources', 'Minerals', 'Forests', 'Water Resources', 'Conservation']
    },
    {
        dir: 'latitudes-longitudes',
        name: 'Latitudes & Longitudes',
        hindiName: 'अक्षांश और देशांतर',
        description: 'Latitudes and longitudes - imaginary lines, time zones, and geographical coordinates.',
        keywords: ['Latitudes', 'Longitudes', 'Time Zones', 'Coordinates', 'Geography']
    },
    {
        dir: 'solar-system',
        name: 'Solar System',
        hindiName: 'सौरमण्डल',
        description: 'Solar System - planets, moons, asteroids, and other celestial bodies.',
        keywords: ['Solar System', 'Planets', 'Moon', 'Asteroids', 'Celestial Bodies']
    },
    {
        dir: 'indian-geography',
        name: 'Indian Geography',
        hindiName: 'भारतीय भूगोल',
        description: 'Indian geography - physical features, climate, rivers, mountains, and regions.',
        keywords: ['Indian Geography', 'Physical Features', 'Climate', 'Rivers', 'Mountains']
    },
    {
        dir: 'indian-freedom-struggle',
        name: 'Indian Freedom Struggle',
        hindiName: 'भारतीय स्वतंत्रता संग्राम',
        description: 'Indian freedom struggle - 1857 revolt, Gandhian era, independence movement.',
        keywords: ['Freedom Struggle', '1857 Revolt', 'Gandhi', 'Independence', 'National Movement']
    },
    {
        dir: 'indian-social-reformers',
        name: 'Indian Social Reformers',
        hindiName: 'भारतीय समाज सुधारक',
        description: 'Indian social reformers - Raja Ram Mohan Roy, Vivekananda, Ambedkar, and others.',
        keywords: ['Social Reformers', 'Raja Ram Mohan Roy', 'Vivekananda', 'Ambedkar', 'Social Reform']
    },
    {
        dir: 'indian-constitution',
        name: 'Indian Constitution',
        hindiName: 'भारतीय संविधान',
        description: 'Indian Constitution - fundamental rights, directive principles, parliament, and judiciary.',
        keywords: ['Constitution', 'Fundamental Rights', 'Parliament', 'Judiciary', 'Civics']
    },
    {
        dir: 'governance-administrative-system',
        name: 'Our Governance & Administrative System',
        hindiName: 'हमारी शासन व्यवस्था',
        description: 'Governance and administrative system - three pillars, elections, and local governance.',
        keywords: ['Governance', 'Administration', 'Democracy', 'Elections', 'Local Governance']
    },
    {
        dir: 'traffic-road-safety',
        name: 'Traffic & Road Safety',
        hindiName: 'यातायात एवं सड़क सुरक्षा',
        description: 'Traffic and road safety - traffic rules, signs, and safe commuting practices.',
        keywords: ['Traffic Safety', 'Road Safety', 'Traffic Rules', 'Signs', 'Safety']
    },
    {
        dir: 'indian-economy-challenges',
        name: 'Indian Economy & Current Challenges',
        hindiName: 'भारतीय अर्थव्यवस्था एवं चुनौतियाँ',
        description: 'Indian economy and current challenges - GDP, sectors, poverty, unemployment.',
        keywords: ['Indian Economy', 'GDP', 'Poverty', 'Unemployment', 'Economic Challenges']
    },
    {
        dir: 'cultural-heritage',
        name: 'Our Cultural Heritage',
        hindiName: 'हमारी सांस्कृतिक विरासत',
        description: 'Cultural heritage - monuments, festivals, art forms, and UNESCO sites.',
        keywords: ['Cultural Heritage', 'Monuments', 'Festivals', 'Art Forms', 'UNESCO']
    },
    {
        dir: 'environmental-conservation',
        name: 'Environmental Conservation',
        hindiName: 'पर्यावरण संरक्षण',
        description: 'Environmental conservation - climate change, biodiversity, pollution, and sustainability.',
        keywords: ['Environment', 'Conservation', 'Climate Change', 'Pollution', 'Sustainability']
    },
    {
        dir: 'natural-disaster-management',
        name: 'Natural Disaster Management',
        hindiName: 'प्राकृतिक आपदा प्रबंधन',
        description: 'Natural disaster management - earthquakes, floods, cyclones, and preparedness.',
        keywords: ['Disaster Management', 'Earthquake', 'Flood', 'Cyclone', 'Preparedness']
    }
];
...
async function main() {
    console.log('╔══════════════════════════════════════════════════════════════╗');
    console.log('║ UP Assistant Teacher - Environmental & Social Studies Microtopics Generator ║');
    ...
    for (let i = 0; i < totalTopics; i++) {
        ...
        // Create microtopic folder directly under environmental-social-studies
    ...
    console.log(`${'='.repeat(80)}`);
    console.log('\n✅ All Environmental & Social Studies microtopic pages generated successfully!');
    console.log('📁 Microtopic folders created directly under: up-assistant-teacher/environmental-social-studies/');
}
...
<head>
    ...
    <meta name="keywords" content="${topic.keywords.join(', ')}, UP Assistant Teacher, पर्यावरण एवं सामाजिक अध्ययन, Environmental Social Studies">
...
<body>
    ...
    <main class="topic-container" id="main-content">
        <a href="/up-assistant-teacher/environmental-social-studies/" class="back-link"><i class="fas fa-arrow-left"></i> <span class="lang-hi">वापस पर्यावरण एवं सामाजिक अध्ययन पर जाएँ</span><span class="lang-en">Back to Environmental & Social Studies</span></a>

        <div class="breadcrumbs">
            <a href="/">Home</a> <i class="fas fa-chevron-right"></i>
            <a href="/up-assistant-teacher/">UP Assistant Teacher</a> <i class="fas fa-chevron-right"></i>
            <a href="/up-assistant-teacher/environmental-social-studies/">पर्यावरण एवं सामाजिक अध्ययन</a> <i class="fas fa-chevron-right"></i>
