/**
 * generate-ssc-cgl-chemistry-html.js
 * Generates 4 bilingual Chemistry topic pages for SSC CGL General Awareness.
 * Output: ssc-cgl/general-awareness/chemistry/<slug>/index.html
 *
...
// ── Topics ───────────────────────────────────────────────────────────────────
const TOPICS = [
    { name: 'States of Matter, Elements, & Compounds', slug: 'states-of-matter-elements-and-compounds' },
    { name: 'Atomic Structure, Periodicity, Acids & Bases', slug: 'atomic-structure-periodicity-acids-and-bases' },
    { name: 'Metals, Non-Metals, & Alloys', slug: 'metals-non-metals-and-alloys' },
    { name: 'Carbon Compounds, Daily Life Chemistry, & Polymers', slug: 'carbon-compounds-daily-life-chemistry-and-polymers' },
];

const OUTPUT_DIR = path.join(
    __dirname,
    'ssc-cgl', 'general-awareness', 'chemistry'
);
...
function buildPrompt(topicName) {
    return `You are the Senior Chemistry Faculty and Content Team of SJMaths.
...
3. Start from absolute beginner level and progress to SSC CGL exam level.
   ...
   Highlight important chemical names, formulae, reactions, SI units, and landmark discoveries.
...
4. CONTENT STRUCTURE for Tab 1 (Concept & Theory) — include ALL applicable sections:
   ...
   - Key Chemical Formulas / Reactions / SI Units (premium-table)
...
<head>
    ...
    <title>${safeTitle} - SSC CGL Chemistry Notes | SJMaths</title>
    <meta name="description" content="Master ${safeTitle} for SSC CGL General Awareness. Bilingual concept notes, formulas, reactions, SI units, practice questions, and exam tips.">
    <meta name="robots" content="index, follow, max-image-preview:large">
    <link rel="canonical" href="https://sjmaths.com/ssc-cgl/general-awareness/chemistry/${slug}/">
    <meta name="keywords" content="${safeTitle}, SSC CGL Chemistry, General Awareness, SSC CGL Tier 1, SJMaths">
    ...
    <style>
        :root {
            --che-grad: linear-gradient(135deg, #27ae60, #16a085);
        ...
        .topic-header h1 { font-family: 'Outfit', sans-serif; font-size: clamp(1.5rem,5vw,2.2rem); font-weight: 800; background: var(--che-grad); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: .4rem; line-height: 1.2; }
        ...
        .tab-btn:hover { color: #27ae60; background: rgba(39,174,96,.05); }
        .tab-btn.active { color: #fff; background: var(--che-grad); box-shadow: 0 4px 10px rgba(39,174,96,.25); }
        ...
        .coming-soon-box { text-align: center; padding: 3rem 1.5rem; background: linear-gradient(135deg, rgba(39,174,96,.03), rgba(22,160,133,.03)); border-radius: 1rem; border: 2px dashed rgba(39,174,96,.2); }
        .coming-soon-box i { font-size: 3rem; color: #27ae60; margin-bottom: 1rem; opacity: .6; }
        ...
        .tab-panel h2 { font-family: 'Outfit', sans-serif; font-size: 1.35rem; font-weight: 700; color: #27ae60; margin-top: 1.25rem; margin-bottom: .85rem; border-bottom: 2px solid rgba(39,174,96,.15); padding-bottom: .35rem; }
        ...
        .premium-table th { background: rgba(39,174,96,.08); font-weight: 700; color: #27ae60; padding: 12px 14px; border-bottom: 2px solid rgba(39,174,96,.15); white-space: nowrap; }
        ...
        .premium-table tr:hover td { background: rgba(39,174,96,.03); }
...
<body>
    ...
    <main class="topic-container" id="main-content">
        <div class="breadcrumbs">
            ...
            <a href="/ssc-cgl/general-awareness/chemistry/">Chemistry</a> <i class="fas fa-chevron-right" style="font-size:.65rem;margin:0 .2rem;"></i>
            <span>${safeTitle}</span>
        </div>
        <div class="topic-header">
            <h1>${safeTitle}</h1>
            <p><span class="lang-en">Complete SSC CGL Chemistry Guide: Concepts, Formulas, Reactions & Exam Tips</span><span class="lang-hi">संपूर्ण SSC CGL रसायन विज्ञान गाइड: अवधारणाएं, सूत्र, अभिक्रियाएं और परीक्षा टिप्स</span></p>
        </div>
...
// ── Main ─────────────────────────────────────────────────────────────────────
async function main() {
    console.log('🧪 SSC CGL Chemistry Page Generator\n');
