/**
 * generate-ssc-cgl-static-gk-html.js
 * Generates 4 bilingual Static GK topic pages for SSC CGL General Awareness.
 * Output: ssc-cgl/general-awareness/static-gk/<slug>/index.html
 *
 * Features:
...
// ── Topics ───────────────────────────────────────────────────────────────────
const TOPICS = [
    { name: 'Important Days, books, & authors', slug: 'important-days-books-and-authors' },
    { name: 'Sports terms, trophies, & personalities', slug: 'sports-terms-trophies-and-personalities' },
    { name: 'World & Indian superlatives, symbols', slug: 'world-and-indian-superlatives-and-symbols' },
    { name: 'International organizations & headquarters', slug: 'international-organizations-and-headquarters' },
];

const OUTPUT_DIR = path.join(
    __dirname,
    'ssc-cgl', 'general-awareness', 'static-gk'
);
...
function buildPrompt(topicName) {
    return `You are the Senior GK Faculty and Content Team of SJMaths.
...
4. CONTENT STRUCTURE for Tab 1 (Concept & Theory) — include ALL applicable sections:
   ...
   - Key Facts / Dates / Names / Events (premium-table)
...
<head>
    ...
    <title>${safeTitle} - SSC CGL Static GK Notes | SJMaths</title>
    ...
    <link rel="canonical" href="https://sjmaths.com/ssc-cgl/general-awareness/static-gk/${slug}/">
    <meta name="keywords" content="${safeTitle}, SSC CGL Static GK, General Awareness, SSC CGL Tier 1, SJMaths">
...
<body>
    ...
    <main class="topic-container" id="main-content">
        <div class="breadcrumbs">
            ...
            <a href="/ssc-cgl/general-awareness/static-gk/">Static GK</a> <i class="fas fa-chevron-right" style="font-size:.65rem;margin:0 .2rem;"></i>
            <span>${safeTitle}</span>
        </div>
        <div class="topic-header">
            <h1>${safeTitle}</h1>
            <p><span class="lang-en">Complete SSC CGL Static GK Guide: Concepts, Facts, Dates & Exam Tips</span><span class="lang-hi">संपूर्ण SSC CGL स्टैटिक जीके गाइड: अवधारणाएं, तथ्य, तिथियां और परीक्षा टिप्स</span></p>
        </div>
...
// ── Main ─────────────────────────────────────────────────────────────────────
async function main() {
    console.log('📚 SSC CGL Static GK Page Generator\n');
    ...
    for (let i = 0; i < TOPICS.length; i++) {
        ...
        try {
            ...
            console.log(`  ✅ Saved: static-gk/${slug}/index.html`);
        } catch (err) {
    ...
    console.log('\n🎉 Static GK generation complete!');
    console.log(`📁 Output: ssc-cgl/general-awareness/static-gk/`);
}
