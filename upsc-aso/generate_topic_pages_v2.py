...
TOPICS = json.loads((pathlib.Path(__file__).parent / "topics_v2.json").read_text(encoding="utf-8"))
...
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://sjmaths.com/"},{"@type":"ListItem","position":2,"name":"UPSC ASO","item":"https://sjmaths.com/upsc-aso/"},{"@type":"ListItem","position":3,"name":"__SUBJECT__","item":"https://sjmaths.com/upsc-aso/__SUBJECT_SLUG__/"},{"@type":"ListItem","position":4,"name":"__TITLE__","item":"https://sjmaths.com/upsc-aso/__SUBJECT_SLUG__/__SLUG__/"}]}
</script>
</head>
<body>
    ...
    <main class="module-container" id="main-content">
        <div class="breadcrumb-nav">
            ...
            <a href="/upsc-aso/__SUBJECT_SLUG__/">__SUBJECT__</a> <i class="fas fa-chevron-right" style="font-size:.7rem"></i>
            <span>Day __DAY__ &bull; __TITLE__</span>
        </div>
        <div class="module-header">
            <h1>__TITLE__</h1>
            <div class="module-badges">
                <span class="badge-tag"><i class="fas fa-calendar-day"></i> Day __DAY__ of 100</span>
...
Topic: {t}
Day: {d} of 100 (100-Day Plan v2) | Subject: {s} | Phase: {ph}
...
def generate_page(topic, call_index):
    ...
    top = (HTML_BOILERPLATE_TOP
           ...
           .replace("__SUBJECT_SLUG__", topic['subject_slug']))
    return top + "\n" + inner + "\n" + HTML_BOILERPLATE_BOTTOM

def save_page(topic, html):
    out_dir = OUTPUT_BASE / topic["subject_slug"] / topic["slug"]
    out_dir.mkdir(parents=True, exist_ok=True)
    out_file = out_dir / "index.html"
    out_file.write_text(html, encoding="utf-8")
    print(f"  Saved: {topic['subject_slug']}/{topic['slug']}/index.html")

def load_progress():
    pf = OUTPUT_BASE / ".gen_progress_v2.json"
    if pf.exists():
...
def main():
    ...
    call_index = len(done)
    print(f"\n{'='*60}")
    print(f"UPSC ASO Pillar Generator v2 | {len(TOPICS)} topics total")
