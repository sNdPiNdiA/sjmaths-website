    ...
    if (user) {
        ...
        profileContainer.innerHTML = `
            <div class="profile-trigger" style="cursor: pointer; display: flex; align-items: center; gap: 10px; padding: 5px;">
                ...
                <span class="user-name" style="font-weight: 600; font-size: 0.9rem; color: var(--text-dark); display: none;">${displayName}</span>
            ...
            ">
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    ...
                    <li style="margin-top: 10px; border-top: 1px solid #eee; padding-top: 10px;">
                        <a href="#" id="logoutAction" style="display: flex; align-items: center; gap: 12px; padding: 10px; color: var(--secondary); border-radius: 10px; transition: background 0.2s; background: rgba(231, 76, 60, 0.05); font-weight: 600; font-size: 0.9rem;">
        ...
        if (parentLi) {
            parentLi.replaceWith(profileContainer);
        } else {
