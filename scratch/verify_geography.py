...
ENG_PATH = r"c:\Users\sande\Documents\GitHub\sjmaths-website\upsc\ancient_history\HarappanIndus-Valley-Civilisation\Geography-and-Archaeological-Findings-of-Indus-Valley-Civilisation\content.json"
HIN_PATH = r"c:\Users\sande\Documents\GitHub\sjmaths-website\upsc\ancient_history\HarappanIndus-Valley-Civilisation\Geography-and-Archaeological-Findings-of-Indus-Valley-Civilisation\hi\content.json"
...
# We must run this programmatically and catch any encoding print issues on Windows
# Since the console might fail on Hindi section titles, we will run and suppress non-ASCII in stdout if needed
try:
