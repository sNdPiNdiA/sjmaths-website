...
// ============================================================================
// UPSSSC PET GEOGRAPHY TOPICS (10 topics from syllabus)
// ============================================================================
const GEOGRAPHY_TOPICS = [
  {
    dir: 'climate-and-weather',
    name: 'Climate & Weather',
    hindiName: 'जलवायु एवं मौसम',
    description: 'Important concepts of climate and weather including atmospheric conditions, seasons, and climatic factors for UPSSSC PET.',
    keywords: ['Climate', 'Weather', 'Monsoon', 'Tropical', 'Temperate', 'Atmospheric Pressure', 'Cyclone', 'El Nino']
  },
  {
    dir: 'rivers-and-river-valleys',
    name: 'Rivers & River Valleys',
    hindiName: 'नदियाँ एवं नदी घाटियाँ',
    description: 'Major rivers of India and the world, their tributaries, river valleys, and significance for civilization and economy.',
    keywords: ['Rivers', 'Ganga', 'Yamuna', 'Brahmaputra', 'Indus', 'River Valley', 'Tributaries', 'Delta']
  },
  {
    dir: 'mountains-hills-glaciers',
    name: 'Mountains, Hills & Glaciers',
    hindiName: 'पर्वत, पहाड़ियाँ एवं हिमनद',
    description: 'Major mountain ranges of India and the world, important peaks, hills, and glaciers for competitive exams.',
    keywords: ['Himalayas', 'Western Ghats', 'Eastern Ghats', 'Mount Everest', 'Kanchenjunga', 'Glaciers', 'Mountain Ranges', 'Peaks']
  },
  {
    dir: 'deserts-and-arid-regions',
    name: 'Deserts & Arid Regions',
    hindiName: 'रेगिस्तान एवं शुष्क क्षेत्र',
    description: 'Major deserts of the world and India, their formation, climate, and characteristics for UPSSSC PET preparation.',
    keywords: ['Thar Desert', 'Sahara', 'Gobi', 'Arabian Desert', 'Desert Climate', 'Arid Region', 'Hot Desert', 'Cold Desert']
  },
  {
    dir: 'forests',
    name: 'Forests',
    hindiName: 'वन',
    description: 'Types of forests in India and the world, forest resources, conservation, and important wildlife sanctuaries for competitive exams.',
    keywords: ['Tropical Forest', 'Mangrove', 'Forest Types', 'Wildlife Sanctuary', 'Sundarbans', 'Silk Route', 'Biodiversity', 'Conservation']
  },
  {
    dir: 'mineral-resources-india',
    name: 'Mineral Resources of India',
    hindiName: 'भारत के खनिज संसाधन',
    description: 'Major mineral resources of India, their locations, production, and important mining areas for UPSSSC PET.',
    keywords: ['Coal', 'Iron Ore', 'Bauxite', 'Mica', 'Manganese', 'Copper', 'Gold', 'Mineral Resources']
  },
  {
    dir: 'groundwater-resources',
    name: 'Groundwater Resources',
    hindiName: 'भूजल संसाधन',
    description: 'Groundwater resources in India, aquifers, water tables, and major groundwater conservation projects for competitive exams.',
    keywords: ['Groundwater', 'Water Table', 'Aquifer', 'CGWB', 'Rainwater Harvesting', 'Watershed', 'Groundwater Depletion', 'Water Conservation']
  },
  {
    dir: 'political-geography-india-world',
    name: 'Political Geography of India & World',
    hindiName: 'भारत एवं विश्व का राजनीतिक भूगोल',
    description: 'Political divisions, borders, states, and international boundaries of India and major countries for UPSSSC PET.',
    keywords: ['States of India', 'Union Territories', 'International Boundaries', 'Border', 'Capitals', 'Political Map', 'Neighbors', 'Disputed Territories']
  },
  {
    dir: 'demographic-changes-migration',
    name: 'Demographic Changes & Migration',
    hindiName: 'जनसंख्या परिवर्तन एवं प्रवासन',
    description: 'Population distribution, demographic transitions, migration patterns, and census data for competitive exams.',
    keywords: ['Population', 'Census', 'Demography', 'Migration', 'Urbanization', 'Population Growth', 'Density', 'Literacy Rate']
  },
  {
    dir: 'time-zones',
    name: 'Time Zones',
    hindiName: 'समय क्षेत्र',
    description: 'World time zones, standard time, International Date Line, and time calculations for competitive exams.',
    keywords: ['Time Zones', 'IST', 'GMT', 'UTC', 'International Date Line', 'Standard Time', 'Longitude', 'Time Calculation']
  }
];
...
function buildConceptsPrompt(topic) {
  return `You are an expert faculty member for UPSSSC PET (Preliminary Eligibility Test) exam preparation. Create ULTRA-COMPREHENSIVE, SEO-OPTIMIZED concept notes for the Geography topic: "${topic.name}" (${topic.hindiName}).
...
4. Content must be **comprehensive and exam-focused** — cover ALL important facts, locations, figures, processes, and concepts that UPSSSC PET asks.
...
- 3-4 detailed tables with 8-12 rows each covering:
  a) Important Rivers/Peaks/Regions/Features with their details and significance
  b) Important Locations/Places with coordinates, state, and significance
...
- Cover frequently confused locations, names, facts, and concepts
...
- Include ALL important locations, names, figures, and concepts.
...
function assemblePage(topic, conceptsData) {
  ...
  const canonicalUrl = `https://sjmaths.com/upsssc-pet/geography/${topic.dir}/`;
  const title = `${topic.name} | UPSSSC PET Geography | SJMaths`;
  const description = topic.description;
  const keywords = `UPSSSC PET, ${topic.name}, Geography, ${topic.hindiName}, ${topic.keywords.join(', ')}`;
...
<body>
  <div class="topic-container">
    <div class="breadcrumbs">
      <div class="breadcrumbs-path">
        ...
        <a href="/upsssc-pet/geography/">Geography</a> <i class="fas fa-chevron-right"></i>
  ...
  ${JSON.stringify({
    topicId: `upsssc-pet.geography.${topic.dir}`,
    topicName: topic.name,
    hindiName: topic.hindiName,
    subject: 'Geography',
    subjectDir: 'geography',
    ...
    sections: [
      {
        ...
        rows: [
          ...
          ['Subject', '**Geography** for UPSSSC PET'],
          ['Status', 'Content under preparation — check back soon for comprehensive notes']
        ]
      }
    ],
    upscNotes: [
      { type: 'tip', content: `This topic is important for UPSSSC PET Geography section. Study ${topic.name} thoroughly.` }
    ],
    keyTakeaways: [
      `Study ${topic.name} thoroughly for UPSSSC PET`,
      'Focus on important locations, features, and facts',
...
async function main() {
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║ UPSSSC PET Geography — Concepts & Theories Tab Generator    ║');
  console.log('║ Model: gemini-3.5-flash-lite                                 ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');

  const totalTopics = GEOGRAPHY_TOPICS.length;
  let successCount = 0;
  let failCount = 0;

  for (let i = 0; i < totalTopics; i++) {
    const topic = GEOGRAPHY_TOPICS[i];
    console.log(`\n${'='.repeat(80)}`);
    console.log(`[${i + 1}/${totalTopics}] Processing: ${topic.name} (${topic.hindiName})`);
    console.log(`${'='.repeat(80)}`);

    const outputDir = path.join(process.cwd(), 'upsssc-pet', 'geography', topic.dir);
  ...
  console.log(`${'='.repeat(80)}`);
  console.log('\nAll UPSSSC PET Geography concepts/theories tabs generated successfully!');
}
