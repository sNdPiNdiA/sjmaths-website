...
// ============================================================================
// UPSSSC PET SCIENCE TOPICS (14 topics from syllabus)
// ============================================================================
const SCIENCE_TOPICS = [
    {
        dir: 'atoms-and-molecules',
        name: 'Atoms & Molecules',
        hindiName: 'परमाणु एवं अणु',
        description: 'Basic concepts of atoms and molecules, atomic structure, molecular formulas, and chemical bonding for UPSSSC PET.',
        keywords: ['Atom', 'Molecule', 'Atomic Structure', 'Element', 'Compound', 'Chemical Bonding', 'Mole Concept', 'Periodic Table']
    },
    {
        dir: 'matter-and-its-states',
        name: 'Matter & Its States',
        hindiName: 'पदार्थ एवं उसकी अवस्थाएँ',
        description: 'States of matter, physical and chemical changes, properties of solids, liquids, and gases for competitive exams.',
        keywords: ['Matter', 'States of Matter', 'Solid', 'Liquid', 'Gas', 'Physical Change', 'Chemical Change', 'Plasma']
    },
    {
        dir: 'chemical-reactions',
        name: 'Chemical Reactions',
        hindiName: 'रासायनिक अभिक्रियाएँ',
        description: 'Types of chemical reactions, balancing equations, oxidation-reduction, acids, bases, and salts for UPSSSC PET.',
        keywords: ['Chemical Reaction', 'Balancing Equation', 'Oxidation', 'Reduction', 'Acid', 'Base', 'Salt', 'pH']
    },
    {
        dir: 'acids-bases-salts',
        name: 'Acids, Bases & Salts',
        hindiName: 'अम्ल, क्षार एवं लवण',
        description: 'Properties of acids, bases, and salts, pH scale, indicators, and important compounds for competitive exams.',
        keywords: ['Acids', 'Bases', 'Salts', 'pH Scale', 'Indicators', 'Litmus', 'Neutralization', 'Hydrochloric Acid']
    },
    {
        dir: 'heat-and-temperature',
        name: 'Heat & Temperature',
        hindiName: 'ऊष्मा एवं तापमान',
        description: 'Concepts of heat, temperature, thermal expansion, specific heat, and modes of heat transfer for UPSSSC PET.',
        keywords: ['Heat', 'Temperature', 'Thermal Expansion', 'Specific Heat', 'Conduction', 'Convection', 'Radiation', 'Thermometer']
    },
    {
        dir: 'light-and-sound',
        name: 'Light & Sound',
        hindiName: 'प्रकाश एवं ध्वनि',
        description: 'Properties of light and sound, reflection, refraction, mirrors, lenses, and sound waves for competitive exams.',
        keywords: ['Light', 'Sound', 'Reflection', 'Refraction', 'Mirror', 'Lens', 'Wave', 'Speed of Light']
    },
    {
        dir: 'electricity-and-magnetism',
        name: 'Electricity & Magnetism',
        hindiName: 'विद्युत एवं चुंबकत्व',
        description: 'Electric current, circuits, Ohm\'s law, magnetic effects, and electromagnetic induction for UPSSSC PET.',
        keywords: ['Electricity', 'Magnetism', 'Electric Current', 'Ohm\'s Law', 'Circuit', 'Magnetic Field', 'Electromagnet', 'Transformer']
    },
    {
        dir: 'motion-and-force',
        name: 'Motion & Force',
        hindiName: 'गति एवं बल',
        description: 'Laws of motion, force, acceleration, velocity, and Newton\'s laws of motion for competitive exams.',
        keywords: ['Motion', 'Force', 'Newton\'s Laws', 'Acceleration', 'Velocity', 'Displacement', 'Inertia', 'Momentum']
    },
    {
        dir: 'work-energy-power',
        name: 'Work, Energy & Power',
        hindiName: 'कार्य, ऊर्जा एवं शक्ति',
        description: 'Concepts of work, energy, power, types of energy, and conservation of energy for UPSSSC PET.',
        keywords: ['Work', 'Energy', 'Power', 'Kinetic Energy', 'Potential Energy', 'Conservation of Energy', 'Joule', 'Watt']
    },
    {
        dir: 'cell-structure',
        name: 'Cell Structure',
        hindiName: 'कोशिका संरचना',
        description: 'Cell theory, cell organelles, plant and animal cells, cell division, and tissues for competitive exams.',
        keywords: ['Cell', 'Cell Theory', 'Organelles', 'Nucleus', 'Mitochondria', 'Cell Division', 'Mitosis', 'Meiosis']
    },
    {
        dir: 'plant-physiology',
        name: 'Plant Physiology',
        hindiName: 'पादप संक्षिक्ति',
        description: 'Plant physiology including photosynthesis, respiration, transpiration, and plant hormones for UPSSSC PET.',
        keywords: ['Photosynthesis', 'Respiration', 'Transpiration', 'Plant Hormones', 'Chlorophyll', 'Stomata', 'Root', 'Leaf']
    },
    {
        dir: 'human-body-systems',
        name: 'Human Body Systems',
        hindiName: 'मानव शरीर की तंत्र',
        description: 'Human body systems including digestive, respiratory, circulatory, nervous, and excretory systems for competitive exams.',
        keywords: ['Human Body', 'Digestive System', 'Respiratory System', 'Circulatory System', 'Nervous System', 'Heart', 'Brain', 'Kidney']
    },
    {
        dir: 'nutrition-and-health',
        name: 'Nutrition & Health',
        hindiName: 'पोषण एवं स्वास्थ्य',
        description: 'Nutrition, balanced diet, vitamins, minerals, diseases, and public health for UPSSSC PET preparation.',
        keywords: ['Nutrition', 'Vitamins', 'Minerals', 'Balanced Diet', 'Disease', 'Immunity', 'Carbohydrates', 'Proteins']
    },
    {
        dir: 'common-diseases',
        name: 'Common Diseases',
        hindiName: 'सामान्य रोग',
        description: 'Common diseases in humans, their causes, symptoms, prevention, and treatment for competitive exams.',
        keywords: ['Diseases', 'Infectious Disease', 'Virus', 'Bacteria', 'Prevention', 'Vaccination', 'Symptoms', 'Treatment']
    }
];
...
function buildConceptsPrompt(topic) {
    return `You are an expert faculty member for UPSSSC PET (Preliminary Eligibility Test) exam preparation. Create ULTRA-COMPREHENSIVE, SEO-OPTIMIZED concept notes for the Science topic: "${topic.name}" (${topic.hindiName}).
...
4. Content must be **comprehensive and exam-focused** — cover ALL important facts, formulas, principles, discoveries, and concepts that UPSSSC PET asks.
...
- 3-4 detailed tables with 8-12 rows each covering:
  a) Important Formulas/Principles/Laws with their formulas and applications
  b) Important Scientists/Discoveries with year, name, and significance
  c) Important Dates/Events/Timeline with events and significance
...
- Cover frequently confused concepts, formulas, values, and principles
...
- Include ALL important formulas, values, principles, discoveries, and concepts.
...
function assemblePage(topic, conceptsData) {
    ...
    const canonicalUrl = `https://sjmaths.com/upsssc-pet/science/${topic.dir}/`;
    const title = `${topic.name} | UPSSSC PET Science | SJMaths`;
    const description = topic.description;
    const keywords = `UPSSSC PET, ${topic.name}, General Science, ${topic.hindiName}, ${topic.keywords.join(', ')}`;
...
<body>
  <div class="topic-container">
    <div class="breadcrumbs">
      <div class="breadcrumbs-path">
        ...
        <a href="/upsssc-pet/science/">Science</a> <i class="fas fa-chevron-right"></i>
  ...
  ${JSON.stringify({
        topicId: `upsssc-pet.science.${topic.dir}`,
        ...
        sections: [
            {
                ...
                rows: [
                    ...
                    ['Subject', '**General Science** for UPSSSC PET'],
                    ['Status', 'Content under preparation — check back soon for comprehensive notes']
                ]
            }
        ],
        upscNotes: [
            { type: 'tip', content: `This topic is important for UPSSSC PET Science section. Study ${topic.name} thoroughly.` }
        ],
        keyTakeaways: [
            `Study ${topic.name} thoroughly for UPSSSC PET`,
            'Focus on important formulas, principles, and discoveries',
...
async function main() {
    console.log('╔══════════════════════════════════════════════════════════════╗');
    console.log('║ UPSSSC PET Science — Concepts & Theories Tab Generator      ║');
    ...
    for (let i = 0; i < totalTopics; i++) {
        const topic = SCIENCE_TOPICS[i];
        console.log(`\n${'='.repeat(80)}`);
        console.log(`[${i + 1}/${totalTopics}] Processing: ${topic.name} (${topic.hindiName})`);
        console.log(`${'='.repeat(80)}`);

        const outputDir = path.join(process.cwd(), 'upsssc-pet', 'science', topic.dir);
    ...
    console.log(`${'='.repeat(80)}`);
    console.log('\nAll UPSSSC PET Science concepts/theories tabs generated successfully!');
}
