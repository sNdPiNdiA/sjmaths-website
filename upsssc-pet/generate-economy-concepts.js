...
const ECONOMY_TOPICS = [
    {
        dir: 'mixed-economy-private-public-sector',
        name: 'Mixed Economy: Private & Public Sector',
        hindiName: 'मिश्रित अर्थव्यवस्था: निजी एवं सार्वजनिक क्षेत्र',
        description: 'Mixed economy concepts, role of public and private sectors, and their contribution to Indian economy for UPSSSC PET.',
        keywords: ['Mixed Economy', 'Public Sector', 'Private Sector', 'PSU', 'Disinvestment', 'Privatization', 'Economic Planning', 'India Economy']
    },
    {
        dir: 'planning-commission-five-year-plans',
        name: 'Planning Commission & Five Year Plans',
        hindiName: 'योजना आयोग एवं पंचवर्षीय योजनाएँ',
        description: 'Planning Commission, Five Year Plans, NITI Aayog, and planned economic development in India for UPSSSC PET.',
        keywords: ['Planning Commission', 'Five Year Plans', 'NITI Aayog', 'Planned Economy', 'GDP Growth', 'Planning', 'Economic Development', 'India']
    },
    {
        dir: 'economic-reforms-1991',
        name: 'Economic Reforms of 1991',
        hindiName: 'वर्ष 1991 के आर्थिक सुधार',
        description: 'Liberalization, Privatization, Globalization (LPG), New Economic Policy 1991, and its impact on Indian economy.',
        keywords: ['Economic Reforms', '1991', 'LPG', 'Liberalization', 'Privatization', 'Globalization', 'New Economic Policy', 'Dr. Manmohan Singh']
    },
    {
        dir: 'economic-reforms-general',
        name: 'Economic Reforms (General)',
        hindiName: 'आर्थिक सुधार (सामान्य)',
        description: 'General economic reforms in India including industrial policy, trade policy, fiscal reforms, and financial sector reforms.',
        keywords: ['Economic Reforms', 'Industrial Policy', 'Trade Policy', 'Fiscal Reforms', 'Financial Sector', 'Banking Reforms', 'Tax Reforms', 'GST']
    },
    {
        dir: 'bank-nationalization-reforms',
        name: 'Bank Nationalization & Reforms',
        hindiName: 'बैंक राष्ट्रीयकरण एवं सुधार',
        description: 'Bank nationalization in India, banking reforms, RRB, NPA, financial inclusion, and digital banking for competitive exams.',
        keywords: ['Bank Nationalization', 'Banking Reforms', 'SBI', 'RRB', 'NPA', 'Financial Inclusion', 'Digital Banking', 'RBI']
    },
    {
        dir: 'green-revolution',
        name: 'Green Revolution',
        hindiName: 'हरित क्रांति',
        description: 'Green Revolution in India, its impact on agriculture, MS Swaminathan, and subsequent agricultural developments for UPSSSC PET.',
        keywords: ['Green Revolution', 'MS Swaminathan', 'High Yielding Variety', 'HYV', 'Agriculture', 'Food Security', 'Punjab', 'Wheat']
    },
    {
        dir: 'agricultural-reforms',
        name: 'Agricultural Reforms',
        hindiName: 'कृषि सुधार',
        description: 'Agricultural reforms in India, land reforms, irrigation, loan waivers, MSP, and recent agricultural policies for competitive exams.',
        keywords: ['Agricultural Reforms', 'Land Reforms', 'Irrigation', 'MSP', 'Loan Waiver', 'Farm Laws', 'Agriculture', 'Farmers']
    },
    {
        dir: 'dairy-development-operation-flood',
        name: 'Dairy Development & Operation Flood',
        hindiName: 'डेयरी विकास एवं ऑपरेशन फ्लड',
        description: 'Operation Flood, White Revolution, Amul, dairy development in India, and Dr. Verghese Kurien for UPSSSC PET.',
        keywords: ['Operation Flood', 'White Revolution', 'Amul', 'Dr. Verghese Kurien', 'Dairy', 'Milk', 'Cooperatives', 'India']
    },
    {
        dir: 'labor-reforms',
        name: 'Labor Reforms',
        hindiName: 'श्रम सुधार',
        description: 'Labor reforms in India, labor laws, industrial relations, workers rights, and recent labor code reforms for competitive exams.',
        keywords: ['Labor Reforms', 'Labor Laws', 'Industrial Dispute', 'Workers Rights', 'Trade Unions', 'Labor Code', 'Minimum Wages', 'EPF']
    },
    {
        dir: 'gst',
        name: 'GST (Goods and Services Tax)',
        hindiName: 'जीएसटी (स commodities एवं सेवा कर)',
        description: 'GST in India, GST Council, GST slabs, GSTN, benefits, challenges, and impact on Indian economy for UPSSSC PET.',
        keywords: ['GST', 'Goods and Services Tax', 'GST Council', 'GSTN', 'CGST', 'SGST', 'IGST', 'Taxation']
    }
];
...
function buildConceptsPrompt(topic) {
    return `You are an expert faculty member for UPSSSC PET (Preliminary Eligibility Test) exam preparation. Create ULTRA-COMPREHENSIVE, SEO-OPTIMIZED concept notes for the Economy topic: "${topic.name}" (${topic.hindiName}).

TOPIC CONTEXT:
- Subject: Indian Economy (भारतीय अर्थव्यवस्था)
...
4. Content must be **comprehensive and exam-focused** — cover ALL important facts, policies, schemes, figures, and concepts that UPSSSC PET asks.
...
- 3-4 detailed tables with 8-12 rows each covering:
  a) Important Policies/Schemes/Reforms with their year, features, and significance
  b) Important Committees/Commissions/Institutions with their role and significance
...
- Cover frequently confused policies, schemes, years, and concepts
...
- Include ALL important policies, schemes, years, names, and figures.
...
function assemblePage(topic, conceptsData) {
    ...
    const canonicalUrl = `https://sjmaths.com/upsssc-pet/economy/${topic.dir}/`;
    const title = `${topic.name} | UPSSSC PET Economy | SJMaths`;
    const description = topic.description;
    const keywords = `UPSSSC PET, ${topic.name}, Indian Economy, ${topic.hindiName}, ${topic.keywords.join(', ')}`;
...
<body>
  <div class="topic-container">
    <div class="breadcrumbs">
      <div class="breadcrumbs-path">
        ...
        <a href="/upsssc-pet/economy/">Economy</a> <i class="fas fa-chevron-right"></i>
  ...
  ${JSON.stringify({
        topicId: `upsssc-pet.economy.${topic.dir}`,
        ...
        sections: [
            {
                ...
                rows: [
                    ...
                    ['Subject', '**Indian Economy** for UPSSSC PET'],
                    ['Status', 'Content under preparation — check back soon for comprehensive notes']
                ]
            }
        ],
        upscNotes: [
            { type: 'tip', content: `This topic is important for UPSSSC PET Economy section. Study ${topic.name} thoroughly.` }
        ],
        keyTakeaways: [
            `Study ${topic.name} thoroughly for UPSSSC PET`,
            'Focus on important policies, schemes, and reforms',
...
async function main() {
    ...
    for (let i = 0; i < totalTopics; i++) {
        const topic = ECONOMY_TOPICS[i];
        console.log(`\n${'='.repeat(80)}`);
        console.log(`[${i + 1}/${totalTopics}] Processing: ${topic.name} (${topic.hindiName})`);
        console.log(`${'='.repeat(80)}`);

        const outputDir = path.join(process.cwd(), 'upsssc-pet', 'economy', topic.dir);
    ...
    console.log(`${'='.repeat(80)}`);
    console.log('\nAll UPSSSC PET Economy concepts/theories tabs generated successfully!');
}
