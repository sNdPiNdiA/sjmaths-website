...
// ============================================================================
// UPSSSC PET GENERAL AWARENESS TOPICS (13 topics from syllabus)
// ============================================================================
const GA_TOPICS = [
    {
        dir: 'awards-winners',
        name: 'Awards & Winners',
        hindiName: 'पुरस्कार एवं विजेता',
        description: 'Important national and international awards, honours, and their recipients for UPSSSC PET General Awareness.',
        keywords: ['Awards', 'Nobel Prize', 'Bharat Ratna', 'Padma Awards', 'Arjuna Award', 'Booker Prize', 'Pulitzer Prize', 'Olympics']
    },
    {
        dir: 'climate-change-environment',
        name: 'Climate Change & Environment',
        hindiName: 'जलवायु परिवर्तन एवं पर्यावरण',
        description: 'Key environmental issues, climate change concepts, and conservation efforts for competitive exams.',
        keywords: ['Climate Change', 'Global Warming', 'Paris Agreement', 'Kyoto Protocol', 'Biodiversity', 'Conservation', 'Pollution', 'Environment']
    },
    {
        dir: 'countries-capitals-currencies',
        name: 'Countries, Capitals & Currencies',
        hindiName: 'देश, राजधानियाँ एवं मुद्राएँ',
        description: 'World geography facts covering countries, their capitals, and official currencies for exam preparation.',
        keywords: ['Countries', 'Capitals', 'Currencies', 'World Geography', 'Continents', 'Dollar', 'Euro', 'Rupee']
    },
    {
        dir: 'famous-books-authors',
        name: 'Famous Books & Authors',
        hindiName: 'प्रसिद्ध पुस्तकें एवं लेखक',
        description: 'Notable literary works and their authors from India and around the world for general awareness.',
        keywords: ['Books', 'Authors', 'Literature', 'Novel', 'Biography', 'Indian Authors', 'World Literature', 'Booker Prize']
    },
    {
        dir: 'india-world-sports',
        name: 'India & World Sports',
        hindiName: 'भारत एवं विश्व खेल',
        description: 'Major sporting events, tournaments, and famous sportspersons for UPSSSC PET preparation.',
        keywords: ['Sports', 'Olympics', 'Cricket', 'Hockey', 'Football', 'Asian Games', 'World Cup', 'Arjuna Award']
    },
    {
        dir: 'indian-art-culture',
        name: 'Indian Art & Culture',
        hindiName: 'भारतीय कला एवं संस्कृति',
        description: 'Rich cultural heritage of India including classical arts, festivals, and traditions for competitive exams.',
        keywords: ['Indian Art', 'Culture', 'Classical Dance', 'Music', 'Festivals', 'Temple Architecture', 'Painting', 'Heritage']
    },
    {
        dir: 'indian-parliament-rajya-sabha-lok-sabha',
        name: 'Indian Parliament (Rajya Sabha & Lok Sabha)',
        hindiName: 'भारतीय संसद (राज्यसभा एवं लोकसभा)',
        description: 'Structure, functions, and procedures of Indian Parliament for UPSSSC PET General Awareness.',
        keywords: ['Parliament', 'Lok Sabha', 'Rajya Sabha', 'President', 'Prime Minister', 'Bills', 'Constitution', 'Election']
    },
    {
        dir: 'indian-research-organizations',
        name: 'Indian Research Organizations',
        hindiName: 'भारतीय अनुसंधान संगठन',
        description: 'Key research institutions and their headquarters in India for general knowledge preparation.',
        keywords: ['ISRO', 'DRDO', 'BARC', 'CSIR', 'ICAR', 'ICMR', 'IIT', 'Research']
    },
    {
        dir: 'indian-states-union-territories',
        name: 'Indian States & Union Territories',
        hindiName: 'भारतीय राज्य एवं केंद्र शासित प्रदेश',
        description: 'States and UTs of India with capitals, areas, and important facts for competitive examinations.',
        keywords: ['Indian States', 'Union Territories', 'Capitals', 'Statehood', 'Reorganization', 'UT', 'Governor', 'Chief Minister']
    },
    {
        dir: 'indian-tourist-places',
        name: 'Indian Tourist Places',
        hindiName: 'भारतीय पर्यटन स्थल',
        description: 'Famous tourist destinations, heritage sites, and monuments across India for general awareness.',
        keywords: ['Tourism', 'Heritage Sites', 'UNESCO', 'Taj Mahal', 'Monuments', 'Pilgrimage', 'Hill Stations', 'Wildlife']
    },
    {
        dir: 'national-international-days',
        name: 'National & International Days',
        hindiName: 'राष्ट्रीय एवं अंतर्राष्ट्रीय दिवस',
        description: 'Important dates, days, and their significance observed nationally and internationally.',
        keywords: ['Important Days', 'World Health Day', 'Environment Day', 'Yoga Day', 'Women Day', 'Human Rights', 'Education', 'Dates']
    },
    {
        dir: 'neighboring-countries-of-india',
        name: 'Neighboring Countries of India',
        hindiName: 'भारत के पड़ोसी देश',
        description: 'India\'s neighboring countries with their capitals, leaders, and key facts for exam preparation.',
        keywords: ['Neighboring Countries', 'Pakistan', 'China', 'Nepal', 'Bhutan', 'Bangladesh', 'Myanmar', 'Sri Lanka']
    },
    {
        dir: 'world-organizations-headquarters',
        name: 'World Organizations & Headquarters',
        hindiName: 'विश्व संगठन एवं मुख्यालय',
        description: 'Major international organizations and their headquarters locations for general awareness.',
        keywords: ['UN', 'WHO', 'UNESCO', 'World Bank', 'IMF', 'WTO', 'NATO', 'SAARC']
    }
];
...
function buildConceptsPrompt(topic) {
    return `You are an expert faculty member for UPSSSC PET (Preliminary Eligibility Test) exam preparation. Create ULTRA-COMPREHENSIVE, SEO-OPTIMIZED concept notes for the General Awareness topic: "${topic.name}" (${topic.hindiName}).

TOPIC CONTEXT:
- Subject: General Awareness (सामान्य जागरूकता)
...
- 3-4 detailed tables with 8-12 rows each covering:
  a) Important Personalities/Organizations/Events with their details and significance
  b) Important Dates/Years/Timeline with events and significance
  c) Important Places/Locations with details and significance
...
function assemblePage(topic, conceptsData) {
    ...
    const canonicalUrl = `https://sjmaths.com/upsssc-pet/general-awareness/${topic.dir}/`;
    const title = `${topic.name} | UPSSSC PET General Awareness | SJMaths`;
    const description = topic.description;
    const keywords = `UPSSSC PET, ${topic.name}, General Awareness, ${topic.hindiName}, ${topic.keywords.join(', ')}`;
        ...
        sections: [
            {
                ...
                rows: [
                    ...
                    ['Subject', '**General Awareness** for UPSSSC PET'],
                    ['Status', 'Content under preparation — check back soon for comprehensive notes']
                ]
            }
        ],
        upscNotes: [
            { type: 'tip', content: `This topic is important for UPSSSC PET General Awareness section. Study ${topic.name} thoroughly.` }
        ],
        keyTakeaways: [
            `Study ${topic.name} thoroughly for UPSSSC PET`,
            'Focus on important facts and figures',
...
async function main() {
    console.log('╔══════════════════════════════════════════════════════════════╗');
    console.log('║ UPSSSC PET General Awareness — Concepts Generator           ║');
    console.log('║ Model: gemini-2.5-flash with fallback                        ║');
    console.log('╚══════════════════════════════════════════════════════════════╝\n');

    const totalTopics = GA_TOPICS.length;
    let successCount = 0;
    let failCount = 0;

    for (let i = 0; i < totalTopics; i++) {
        const topic = GA_TOPICS[i];
        console.log(`\n${'='.repeat(80)}`);
    ...
    console.log(`${'='.repeat(80)}`);
    console.log('\nAll UPSSSC PET General Awareness concepts/theories tabs generated successfully!');
}
